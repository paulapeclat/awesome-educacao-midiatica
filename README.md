# Awesome Educação Midiática 📚🇧🇷

> Lista curada de recursos sobre **educação midiática** em português — políticas públicas, teoria, organizações, ferramentas e prática de sala de aula.

Mantida por [Paula Peclat](https://github.com/paulapeclat) — pedagoga, pesquisadora em educação midiática (PPGEduc/UFRRJ) e fundadora da [APedê Digital](https://paulapeclat.com.br).

**Curadoria em construção** — sugestões são bem-vindas via [issues](../../issues) ou pull requests. Critério: recursos verificáveis, ativos e úteis para educadoras/es, pesquisadoras/es e famílias.

---

## Sumário

- [Marcos legais e políticas públicas 🇧🇷](#marcos-legais-e-políticas-públicas-)
- [Referenciais teóricos](#referenciais-teóricos)
- [Organizações e redes](#organizações-e-redes)
...
- [Lei 14.533/2023 — Política Nacional de Educação Digital (PNED)](https://www.planalto.gov.br/ccivil_03/_ato2023-2026/2023/lei/L14533.htm) — Estrutura a educação digital no Brasil em quatro eixos, incluindo capacitação e letramento digital.
...
- [Marco Civil da Internet — Lei 12.965/2014](https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2014/lei/l12965.htm) — Princípios, garantias e deveres para o uso da internet no Brasil.
...
- **David Buckingham** — *Media Education: Literacy, Learning and Contemporary Culture*; referência central em educação midiática como leitura crítica E produção.
- **Sonia Livingstone** — Pesquisas sobre crianças, internet e direitos digitais; coordena o [Global Kids Online](http://globalkidsonline.net).
- **Henry Jenkins** — Cultura participativa e cultura da convergência; base para pensar crianças como produtoras de mídia.
- **Paulo Freire** — Leitura crítica do mundo como fundamento da leitura crítica das mídias.
- **William Corsaro** — Sociologia da Infância; reprodução interpretativa e culturas de pares.
- **Manuel Jacinto Sarmento** — Culturas da infância e a criança como ator social.
...
- [Code.org — formação para educadores](https://code.org/educate) — Trilhas gratuitas de ciência da computação com foco pedagógico (inglês/português parcial).

## Ferramentas para sala de aula

*Do concreto ao abstrato — a ordem importa pedagogicamente.*
...
- [Thunkable](https://thunkable.com) — Criação de aplicativos móveis por blocos.
...
2. Ou envie um PR seguindo o formato: `[Nome](link) — descrição em uma linha, terminando com ponto.`
3. Recursos precisam estar ativos, ser verificáveis e ter relevância direta para educação midiática.

## Licença

[CC0 1.0 Universal](https://creativecommons.org/publicdomain/zero/1.0/deed.pt-br) — domínio público. Compartilhe à vontade.
